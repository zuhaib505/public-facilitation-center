        ...
        <form method="POST" novalidate>
            ...
            <div class="form-group">
                ...
                <div class="input-group input-group-merge">
                    <input id="username" name="username" type="text" required="" class="form-control form-control-prepended" placeholder="Enter Username">
    ...
    <div class="login-box-body">
        ...
        <form class="login-form" name="form1" id="fomr1" action="" method="post">
            ...
            <div class="form-group has-feedback">
                ...
                <input name="username" id="username" autocomplete="off" type="text" class="form-control" placeholder="Username">
