...
if ($output['status']) {
    $temp = "SELECT * FROM tbl_emails WHERE email_type='booking'";
    ...
    $admin_data = array(
        ...
        "MSG_BODY" => "There ia a request for call back, Please contact the customer for consultaion..."
    );
    $msg_data = array(
        "Ful Name" => $fullname,
        "Email Address" => $email,
    ...
    if ($site_driver == "mail") {
        ...
        $output['message'] = "Your Request has been sent, we will contact you soon";
    } else {
