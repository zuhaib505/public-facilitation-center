...
<head>
    ...
    <body>
                        ...
                        <div class="contact-wrapper">
                            ...
                            <form class="contact-form">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form_group">
                                            <input type="text" class="form_control" placeholder="Enter Name" name="name"
                                            required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form_group">
                                            <input type="email" class="form_control" placeholder="Enter Email" name="email"
                                            required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
        ...
        </section><!--====== End Contact-area Section ======-->
        ...
        </section><!--====== End contact-map-section Section ======-->
        <!--====== Start Footer ======-->
