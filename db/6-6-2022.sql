...
CREATE TABLE `tbl_requests` (
  ...
  `req_sender_name` varchar(100) DEFAULT NULL,
  `req_sender_email` varchar(100) DEFAULT NULL,
  `req_sender_phone` varchar(20) DEFAULT NULL,
  `req_subject` varchar(255) DEFAULT NULL,
  `req_message` varchar(255) DEFAULT NULL,
  `req_status` int(1) NOT NULL,
  `req_accept` int(1) NOT NULL,
...
INSERT INTO `tbl_users` (`user_id`, `user_profile_image`, `user_name`, `user_username`, `user_slug`, `user_email`, `user_contact`, `user_password`, `user_city`, `user_location`, `service_id`, `user_status`, `user_order`, `user_login_session`) VALUES
