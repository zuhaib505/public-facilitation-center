...
<head>
    ...
    <body>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="breadcrumbs-content text-center">
                            ...
                            <ul>
                                <li><a href="#">Home</a></li>
                                <li class="active">Professional-Single</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="service-details-wrapper">
                            <div class="title">
                                <a href="#" class="cat-btn">Type</a>
                                <h3>Professional's Detail</h3>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="sidebar-widget-area">
                            <div class="widget service-widget mb-40">
                                ...
                                <ul class="list">
                                    <li><a href="professional-details.html">Education</a></li>
                                    <li><a href="professional-details.html">Car Repairing</a></li>
                                    <li><a href="professional-details.html">Bike Repairing</a></li>
                                    <li><a href="professional-details.html">Electricians</a></li>
                                </ul>
                            </div>
        ...
        </section><!--====== End service-details-section Section ======-->
       <!--====== Start Footer ======-->
